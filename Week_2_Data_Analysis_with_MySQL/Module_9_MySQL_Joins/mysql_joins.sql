...
-- Database used: join_demo   (cleanup: DROP DATABASE join_demo;)
-- Note: CREATE TABLE statements have no IF NOT EXISTS, so a second run errors (DROP DATABASE join_demo first).
-- =====================================================================
