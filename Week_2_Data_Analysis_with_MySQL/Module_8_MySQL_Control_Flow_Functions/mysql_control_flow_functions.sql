-- =====================================================================
-- MysticML Journey · Week 2 · Module 8 – Control Flow Functions
-- Original practice file (learner's own work). The fuller companion
-- script in this folder is 02_*_complete.sql – see README.md.
-- Database used: control_flow_demo   (cleanup: DROP DATABASE control_flow_demo;)
-- Note: CREATE DATABASE has no IF NOT EXISTS, so it errors on a second run.
-- =====================================================================
